...
import SelectBox from "../../../components/common/SelectBox"; // Pastikan path benar! (Gunakan punya laporan/rapor)

export default function RekapPresensiToolbar({
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between gap-4 bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
      <div className="flex flex-wrap lg:flex-nowrap gap-3 w-full lg:w-auto">
        <SelectBox
          options={["Juli 2026", "Agustus 2026", "September 2026"]}
          value={filterBulan}
