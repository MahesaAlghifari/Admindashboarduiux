import AktivitasTableRow from "./AktivitasTableRow";

export default function AktivitasTable({ 
  data, getAktivitasData, onPrintItem, 
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 text-slate-500 uppercase text-[11px] border-b border-slate-200 tracking-wider">
            <tr>
              ...
              <th className="px-6 py-4 text-center">Jumlah Kegiatan</th>
            ...
            {data.length > 0 ? (
              data.map((item) => (
                <AktivitasTableRow 
                  ...
                  aktivitasData={getAktivitasData(item.id)} 
                  onPrint={onPrintItem}
